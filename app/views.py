...
from .form import  UserForm, ProfileForm, UserEditForm, ProfileEditForm, CommentForm
...
class DeleteProfileView(DeleteView):
    model = User
    template_name="Profile.html"
    success_url = reverse_lazy("app:signup")
...
class DeletePostView(DeleteView):
    ...
    def get_success_url(self):
           ...
           return reverse("app:profile", kwargs={"pk": profile_pk})
...
class UpdatePostView(UpdateView):
    ...
    def get_success_url(self):
           pk = self.kwargs["pk"]
           return reverse("app:post", kwargs={"pk": pk})
...
def UpdateProfileView(request):
    ...
    if request.method == 'POST':
        if user_form.is_valid() and user_profile_form.is_valid():
            ...
            return HttpResponseRedirect(reverse('app:profile', args=[request.user.profile.id] ))
    context = {
        "user_form": user_form,
